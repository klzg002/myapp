...
$(document).ready(function(){
    ...
    $('#registerBtn').bind('click',function(){
        ...
        $.ajax({
            url:"/api?command=postinfo&phone="+$('.lginput.phone')[0].value+"&copyright="+$('.lginput.copyright')[0].value+"&userid="+userdata.userid+"&account="+userdata.account+"&response=json",
            type:"post",
            async:false,
            dataType:"text",
